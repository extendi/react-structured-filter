...
var Tokenizer = function (_Component) {
  ...
  function Tokenizer() {
    ...
    _this._clearTokens = _this._clearTokens.bind(_this);
    _this._removeDatePicker = _this._removeDatePicker.bind(_this);
    return _this;
  }
  ...
  _createClass(Tokenizer, [{
    ...
    key: '_removeDatePicker',
    value: function _removeDatePicker() {
      var _this3 = this;

      this.setState({ operator: '' }, function () {
        _this3.refs.typeahead.getInstance().setEntryText('');
        _this3.refs.typeahead.getInstance()._onFocus();
        _this3.refs.typeahead.getInstance().inputRef().focus();
      });
    }
  }, {
    key: '_onKeyDown',
    value: function _onKeyDown(event) {
      ...
      // without a selection
      var entry = _reactDom2.default.findDOMNode(this.refs.typeahead.getInstance().inputRef());
      //debugger
      if (entry.selectionStart === entry.selectionEnd && entry.selectionStart === 0) {
        if (this.state.operator !== '') {
          ...
          if (this._getCategoryType(lastSelected.category) !== 'textoptions') {
            this.refs.typeahead.getInstance().setEntryText(lastSelected.value);
          }
        }
    ...
    value: function _addTokenForValue(value) {
      ...
      this.setState({
        ...
        return _this4.refs.typeahead.getInstance().inputRef().focus();
      });
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'span',
                { className: !this.state.category ? '' : 'p-r-5' },
                this.state.category
              )
            ),
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'span',
                { className: !this.state.operator ? '' : 'p-r-5' },
                this.state.operator
              )
            ),
        ...
        this.state.selected.length > 0 && _react2.default.createElement(
          'div',
          { className: 'filter-clear-search' },
          _react2.default.createElement(
            'a',
            { title: 'Clear search', onClick: function onClick() {
                return _this5._clearTokens();
              } },
            'x'
          )
        )
...
Tokenizer.propTypes = {
   ...
   */
  readOnlyDatePicker: _propTypes2.default.bool
};
