...
var TypeaheadSelector = function (_Component) {
  ...
  function TypeaheadSelector() {
    ...
    _this.repositionOnScroll = _this.repositionOnScroll.bind(_this);
    return _this;
  }
  ...
  _createClass(TypeaheadSelector, [{
    ...
    key: 'repositionOnScroll',
    value: function repositionOnScroll() {
      var increment = 0;
      var listHeight = this.refs.itemList.offsetHeight;
      var itemHeight = this.refs.itemList.children[1].offsetHeight;
      debugger;
      var itemInDropdown = listHeight / itemHeight - 1;
    ...
    value: function _nav(delta) {
      ...
      this.setState({
        ...
        return _this2.repositionOnScroll();
      });
    }
  }, {
    key: 'navDown',
    ...
    value: function render() {
      ...
      var results = this.props.options.map(function (result, i) {
        return _react2.default.createElement(
          _option2.default,
          {
            ...
            key: result,
            result: result,
            hover: _this3.state.selectionIndex === i,
            customClasses: _this3.props.customClasses,
      ...
      return _react2.default.createElement(
        'ul',
        { ref: 'itemList', className: classList },
