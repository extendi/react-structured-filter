...
var Typeahead = function (_Component) {
  ...
  function Typeahead() {
    ...
    _this._onKeyDatePicker = _this._onKeyDatePicker.bind(_this);
  ...
  _createClass(Typeahead, [{
    ...
    value: function _handleDateChange(date) {
      ...
      var newDate = (0, _moment2.default)(date, this.props.dateFormat);
    ...
    key: '_onKeyDatePicker',
    value: function _onKeyDatePicker(event) {
    ...
    value: function render() {
      ...
      if (this._showDatePicker()) {
        var defaultDate = (0, _moment2.default)(this.state.entryValue, this.props.dateFormat);
